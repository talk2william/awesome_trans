...
-- Set custom icons   
    if c.class == "Google-chrome" then
      local icon = gears.surface("/home/art-attack/.icons/Flattr/apps/64/square_chrome_logo.png")
      return text, bg, bg_image, icon
    end
    
    if c.class == "Firefox" then
      local icon = gears.surface("/home/art-attack/.icons/Flattr/apps/64/firefox.svg")
      return text, bg, bg_image, icon
    end
    
    if c.class == "Dolphin" then
      local icon = gears.surface("/home/art-attack/.icons/Flattr/apps/64/kwalletmanager.svg")
      return text, bg, bg_image, icon
    end
    
    if c.class == "feh" then
      local icon = gears.surface("/home/art-attack/.icons/Flattr/apps/64/gwenview.svg")
      text = "<span color='#ffffff'>feh</span>"
      return text, bg, bg_image, icon
    end
    
    if c.class == "Vlc" then
      local icon = gears.surface("/home/art-attack/.icons/Flattr/apps/64/vlc.svg")
      return text, bg, bg_image, icon
    end
    
    if c.class == "Gimp" then
      local icon = gears.surface("/home/art-attack/.icons/Flattr/apps/64/gimp.png")
      return text, bg, bg_image, icon
    end
    
    if c.class == "Sublime" then
      local icon = gears.surface("/home/art-attack/.icons/Flattr/apps/64/sublime_text.svg")
      return text, bg, bg_image, icon
    end
--    
